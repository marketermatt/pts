...
if(!function_exists('pts_style_init')) {
    function pts_style_init()
    {
        ...
        echo '.wpb_accordion_section .ui-state-default{border: 1px solid '.ot_get_option('pts_accent_color').';}';
                ...
                if(ot_get_option('pts_menu_font')){ echo '.head-nav .navbar-nav li a, .shopping-cart{font-family:'.pts_get_chosen_google_font(ot_get_option('pts_menu_font')['font-family']).'; color:'.ot_get_option('pts_menu_font')['font-color'].'; font-size:'.ot_get_option('pts_menu_font')['font-size'].'; font-style:'.ot_get_option('pts_menu_font')['font-style'].'; font-variant:'.ot_get_option('pts_menu_font')['font-variant'].'; font-weight:'.ot_get_option('pts_menu_font')['font-weight'].'; letter-spacing:'.ot_get_option('pts_menu_font')['letter-spacing'].';  line-height:'.ot_get_option('pts_menu_font')['line-height'].'; text-decoration:'.ot_get_option('pts_menu_font')['text-decoration'].'; text-transform:'.ot_get_option('pts_menu_font')['text-transform'].'; }'; }
